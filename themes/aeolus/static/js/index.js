 ...
 */
{
	...
	// glitch logo at random
var randomWidth = 8000;
var randomBottom = 3000;
...
function animate(){
    ...
    indexTimer = setInterval(animate, parseInt(randomBottom + Math.random() * randomWidth));
}

var indexTimer = setInterval(animate, randomBottom);